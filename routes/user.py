...
@bp.route('/business-0/<int:business_id>', methods=['GET', 'POST'])
def business_profile_0(business_id):
...
@bp.route('/business-0/<int:business_id>/public')
def public_business_profile_0(business_id):
    conn = None
    try:
        conn = get_db_connection()
        cur = conn.cursor(dictionary=True)
